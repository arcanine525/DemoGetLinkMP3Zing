...
var headers = {
    ...
    'Accept': '*/*',
    'Referer': 'http://mp3.zing.vn/bai-hat/Minh-La-Gi-Cua-Nhau-Lou-Hoang/ZW78I80B.html',
...
var options = {
    url: 'http://mp3.zing.vn/json/song/get-download?panel=.fn-tab-panel-service&code=kncnykGaWsQcuJsTkbJTFHZG&group=.fn-tab-panel',
    headers: headers,
    gzip: 'true'
};
